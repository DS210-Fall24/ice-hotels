...
Fill in the blanks in the code for filtering for hotel bookings where the guest is **not** 
...
Calculate the minimum, mean, median, and maximum average daily rate (`adr`) grouped 
